        ...
        k.state("patrol-right", ["patrol-right", "patrol-left", "attack", "alert", "retreat"]),
        {
            ...
            setBehaviour() {
                ...
                this.onStateUpdate("attack", () => {//We want to attack state to take place without any entering in the state yet we can write it but we want it to start it immediately
                    ...
                    this.flipX = player.pos.x <= this.pos.x;
                    this.moveTo(k.vec2(player.pos.x + 45, player.pos.y), this.pursuitSpeed)//Function offered by kaboom to body containing elements it takes position and then a speed 
                })
            ...
            setEvents() {
                ...
                this.onUpdate(() => {
                    ...
                    if (this.pos.dist(player.pos) <= 53 && this._attackCooldown <= 0) {
                        ...
                        const goblinHitBox = this.add([
                            ...
                            k.area({ shape: new k.Rect(k.vec2(offX, -25), 50, 45) }),
                            "creature-hitbox",
                        ]);
