...
def repack_image():
    input_path = "assets/sprites/boss7/boss7.png"
    output_path = "assets/sprites/boss7/boss7_repacked.png"
    ...
    try:
        ...
        # Original: 16 columns, 5 rows (based on texture size 3072x640 and sliceX=16, sliceY=5 logic)
        cols_orig = 16
        rows_orig = 5
        ...
        if frame_width * cols_orig != img.width or frame_height * rows_orig != img.height:
            print("Warning: Image dimension is not perfectly divisible by columns/rows!")
        
        total_frames = cols_orig * rows_orig # 80 frames
        
        # Target: Fits in 2048x2048
        # Frame width is 192. 2048 // 192 = 10.
        cols_new = 10
        import math
        ...
        print(f"New Layout: {cols_new} columns, {rows_new} rows")
